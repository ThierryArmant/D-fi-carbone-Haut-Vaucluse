...
# 2. STYLE CSS (Glassmorphism Universel & Étanchéité Graphique)
def set_style(img_b64):
    ...
    st.markdown(
        ...
        /* Force la transparence absolue des rideaux natifs de Streamlit */
        .stApp, [data-testid="stMain"], .main, [data-testid="stVerticalBlock"] {{
            background-color: transparent !important;
        }}
        
        /* Conteneur global de la zone centrale */
        .main .block-container {{
            background-color: rgba(9, 13, 22, 0.3) !important; /* Voile d'ambiance très léger */
            border-radius: 16px;
            padding: 1rem 2rem !important;
            color: #f1f5f9;
        }}
        
        /* --- 💎 CYBER-BOUCLIER GLASSMORPHISM (S'applique à TOUS les conteneurs de l'app) --- */
        div[data-testid="stVerticalBlockBorderWrapper"], 
        div[data-testid="stBorderedContainer"],
        .stVerticalBlockBorderWrapper,
        .stExpander {{
            background-color: rgba(15, 23, 42, 0.82) !important; /* Teinte Gris Crystal Profond */
            backdrop-filter: blur(16px) saturate(150%) !important; /* Puissant effet Verre Dépoli */
            -webkit-backdrop-filter: blur(16px) saturate(150%) !important;
            border: 1px solid rgba(255, 255, 255, 0.18) !important; /* Liseré cristal brillant */
        ...
        /* Composants internes des dalles */
...
# Fonction de rendu des barres ADEME
...
# Connexion Base de Données Sheets
votre_gid = "169103083" 
...
with tab_dashboard:
    if not df.empty:
        ...
        # Titre principal en bloc Crystal
        ...
        # Les deux fiches du haut reçoivent automatiquement l'effet Gris Crystal
