...
with tab_glossaire:
    ...
    with g_tabs[1]:
        ...
        3. 👕 <b>Le piège des fenêtres :</b> Ouvrir les fenêtres en hiver alors que le chauffage tourne à fond, c'est rejeter l'impact carbone de <b>2 t-shirts neufs</b> en pur gaspillage.
        </div>
        """, unsafe_allow_html=True)
...
st.divider()
st.caption("Sources des référentiels : Base Empreinte ADEME / Simulateur National 'Nos Gestes Climat' - Mai 2026")
