...
# 1. Configuration de la page pour occuper tout l'écran
st.set_page_config(page_title="Hub IA - EPS Aix-Marseille", layout="wide")

# 2. Affichage direct du design original à deux colonnes (sans écran de verrouillage)
st.markdown("""
<!DOCTYPE html>
<html lang="fr">
<head>
...
<body>
    ...
    <div class="hub-container">
        ...
        <div class="bot-card">
            <div class="bot-header">📊 Tableau de Suivi & Données Cantine</div>
            <div class="chat-section">
