...
liste_etablissements = ["SAINT-EXUPERY", "JEAN-GIONO", "A.BRIAND", "VICTOR-SCHOELCHER", "F.REVOUL", "ST-JEAN-LE-BATISTE", "L.AUBRAC", "ST-LOUIS", "H.BOUDON", "P.ELUARD", "ARAUSIO", "VALLIS-AERIA", "ARGENSOL", "B-HENDRICKS", "L-ARC", "LYCEE-VITICOLE", "JULES-FERRY", "GRILLON", "CURIE"] 
